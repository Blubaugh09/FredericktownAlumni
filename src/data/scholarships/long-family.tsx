...
export default function LongFamilyContent() {
  return (
    <div className="text-gray-800">
      ...
      <h4 className="text-xl font-semibold mb-3 text-school-red">The Knox County Citizen Legacy</h4>
      ...
      <h4 className="text-xl font-semibold mb-3 text-school-red">Main Street Free Press Museum</h4>
      ...
      <h4 className="text-xl font-semibold mb-3 text-school-red">Community Involvement</h4>
      ...
      <h4 className="text-xl font-semibold mb-3 text-school-red">Journalism Excellence and Education</h4>
      ...
      <h4 className="text-xl font-semibold mb-3 text-school-red">Scholarship Preference</h4>
      ...
      <div className="mt-6 p-4 bg-school-red text-white rounded-lg">
        <h5 className="font-semibold mb-2 !text-white">Legacy of Truth and Journalism</h5>
      ...
      <div className="mt-6 p-4 bg-gray-100 rounded-lg">
        <h5 className="font-semibold mb-2 text-school-red">Support the Long Family Scholarship</h5>
