...
export default function WilliamMaryElderContent() {
  return (
    <div className="text-gray-800">
      ...
      <h4 className="text-xl font-semibold mb-3 text-school-red">Early Years and Education</h4>
      ...
      <h4 className="text-xl font-semibold mb-3 text-school-red">Return to Fredericktown</h4>
      ...
      <h4 className="text-xl font-semibold mb-3 text-school-red">Professional Achievements</h4>
      ...
      <h4 className="text-xl font-semibold mb-3 text-school-red">Community Leadership and Recognition</h4>
      ...
      <h4 className="text-xl font-semibold mb-3 text-school-red">Faith and Family</h4>
      ...
      <div className="mt-6 p-4 bg-school-red text-white rounded-lg">
        <h5 className="font-semibold mb-2 !text-white">Legacy of Service</h5>
      ...
      <div className="mt-6 p-4 bg-gray-100 rounded-lg">
        ...
        <p className="text-sm text-gray-700 mb-3">
          For more information about Dr. William & Mary Bowlus Elder and their contributions to the Fredericktown community, visit:
        </p>
        <a 
          href="https://fredericktown.touchpros.com/ViewProfile?tabid=8898&showFilterResults=1&filtertype=All&theme=modern_school&res_page=4&Id=284117" 
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center text-school-red hover:text-red-800 font-medium"
        >
