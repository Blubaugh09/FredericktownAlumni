...
export default function ArtBeverlyDremannScholarship() {
  return (
    <div className="space-y-6">
      ...
      <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Beverly Jo Henwood Dremann</h3>
      <p className="text-lg text-gray-800 leading-relaxed">
      ...
      <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Art Dremann</h3>
      <p className="text-lg text-gray-800 leading-relaxed">
      ...
      <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">The Dremann Family Legacy</h3>
      <p className="text-lg text-gray-800 leading-relaxed">
